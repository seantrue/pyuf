...
class Pump(object):
    ...
    def set_pump(self, val):
        if val == u'on':
            self.ports[u'cmd_sync'][u'handle'].call(u'M2231 V1')
        else:
            self.ports[u'cmd_sync'][u'handle'].call(u'M2231 V0')
        
        # TODO: modify the default timeout time with a service command
        for _ in xrange(20):
            ret = self.ports[u'cmd_sync'][u'handle'].call(u'P2231')
            if val == u'on':
    ...
    def service_cb(self, msg):
        ...
        if param == u'value':
            ...
            if action == u'get':
                ret = self.ports[u'cmd_sync'][u'handle'].call(u'P2233')
